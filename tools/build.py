...
feat("spellcasting","Заклинания",1,"zaklinaniya","icons/magic/nature/root-vine-fire-entangled-hand.webp",
...
adapt_fx=[
 ...
 ae("Адаптация: Пустыня","icons/magic/fire/flame-burning-campfire-yellow.webp",[C("system.traits.dr.value","ADD","fire")],False,True,"Сопротивление Огнём."),
...
feat("extraattack","Дополнительная атака",5,"dopolnitelnaya-ataka","icons/skills/melee/blade-tips-triple-bronze.webp",
...
feat("allterrain","Вездеход",6,"vezdehod","icons/magic/movement/feet-bare-light-blue.webp",
...
feat("naturetongue","Язык природы",9,"yazyk-prirody","icons/magic/nature/wolf-paw-glow-small-teal.webp",
...
apex_fx=[ae("Вершина пищевой цепи — против Добычи","icons/skills/targeting/target-strike-triple-red.webp",[C("flags.dnd5e.weaponCriticalThreshold","DOWNGRADE","18")],False,True,"Крит 18–20. Включать только при атаках по Добыче.")]
feat("apex","Вершина пищевой цепи",18,"vershina-pishchevoj-cepi","icons/creatures/abilities/mouth-teeth-sharp-red.webp",
...
cls={"_id":mid("CLASSsledopyt"),"name":"Альтернативный Следопыт","type":"class",
 "img":"icons/magic/nature/elk-running-grass-green.webp",
