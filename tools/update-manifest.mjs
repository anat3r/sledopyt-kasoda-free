...
// Local use: node tools/update-manifest.mjs v0.3.0 owner/repo
...
if (!tag || !repo) {
  console.error("Usage: update-manifest.mjs <tag vX.Y.Z> <owner/repo>  (or set RELEASE_TAG / GITHUB_REPOSITORY)");
  process.exit(1);
}
